...
library(sf)
rural_index = st_read("../../../blogdown_datasets/SG_UrbanRural_2016/", 
...
Finally, *tmap* can switch to using an interactive map (bit better on the web) by changing the view. This uses the [leaflet](http://rstudio.github.io/leaflet/){target="_blank"} package which we could have used directly but I like that a single package can easily switch between static and interactive maps.
